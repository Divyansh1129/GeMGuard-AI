  ...
  return (
    <header className="sticky top-0 z-30 h-16 bg-surface-container-lowest border-b border-outline-variant flex items-center justify-between px-4 lg:px-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          type="button"
          className="relative p-2 rounded-lg hover:bg-surface-container-high text-on-surface-variant transition-all duration-150 ease-out active:scale-90"
        ...
        <button
          ...
          className="hidden md:flex items-center gap-2 bg-surface-container-low rounded-full px-3 py-1.5 border border-outline-variant ml-1 hover:bg-surface-container-high transition-colors cursor-pointer"
